...
export function AppLayout({ children }: { children: ReactNode }) {
  ...
  const items: NavItem[] = [
    ...
    { to: "/bandeja/revision", label: "Bandeja de revisión", show: hasRole("verificador") || hasRole("contador") || hasRole("admin") },
    { to: "/bandeja/autorizacion", label: "Bandeja de autorización", show: hasRole("autorizador") || hasRole("admin") },
    { to: "/dashboard", label: "Dashboard", show: hasRole("verificador") || hasRole("contador") || hasRole("autorizador") || hasRole("admin") },
